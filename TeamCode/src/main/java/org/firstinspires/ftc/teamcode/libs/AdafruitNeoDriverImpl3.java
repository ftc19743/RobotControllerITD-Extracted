...
@I2cDeviceType
@DeviceProperties(name = "Adafruit NeoDriver3", xmlTag = "AdafruitNeoDriver3", description = "an Adafruit NeoDriver board", builtIn = false)
public class AdafruitNeoDriverImpl3 extends I2cDeviceSynchDeviceWithParameters<I2cDeviceSynch, AdafruitNeoDriverImpl3.Parameters>
    ...
    public AdafruitNeoDriverImpl3(I2cDeviceSynch deviceClient, boolean deviceClientIsOwned) {
        this(deviceClient, deviceClientIsOwned, new Parameters());
    }

    protected AdafruitNeoDriverImpl3(I2cDeviceSynch i2cDeviceSynch, boolean deviceClientIsOwned, @NonNull Parameters defaultParameters) {
